...
public static class ApplicationServiceExtensions
{
    ...
    private static IServiceCollection AddRepositories(this IServiceCollection services)
    {
        ...
        services.AddScoped<IDailyExpenseCategorieRepository, DailyExpenseCategorieRepository>();
    ...
    private static IServiceCollection AddApplicationServices(this IServiceCollection services)
    {
        ...
        services.AddScoped<IDailyExpenseCategorieRecalculationService, DailyExpenseCategorieRecalculationService>();
        services.AddScoped<IBackgroundTaskSystemProvider, HangfireBackgroundTaskSystemProvider>();
